# Regressão_por_Potência
def Regressão_potência(x_old=[], y_old=[], view="parcial"):
    """
    Realiza a regressão por potência para um conjunto de dados.
